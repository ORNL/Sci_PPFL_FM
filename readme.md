...
**The 3rd Workshop on Federated and Privacy-Preserving AI for HPC (FPAI-HPC '26)** — a workshop co-located with the IEEE International Conference on Cluster Computing 2026 (Cluster '26), held September 22, 2026 in Alexandria, Virginia, and led by Oak Ridge National Laboratory. The workshop brings researchers and practitioners together to advance trustworthy AI across distributed supercomputing environments without centralizing sensitive data.
...
1. **IntraShuffler: A Privacy Preserving Framework for Heterogeneous DP Federated Learning**  
   *40th Annual IFIP WG 11.3 Conference on Data and Applications Security and Privacy (DBSec 2026)* <br>
   [Link](https://link.springer.com/chapter/10.1007/978-3-032-33260-8_3)
...
2. **XMark: Reliable Multi-Bit Watermarking for LLM-Generated Texts**  
   *The 64th Annual Meeting of the Association for Computational Linguistics (ACL 2026)* <br>
   [Link](https://aclanthology.org/2026.acl-long.672.pdf) | [Code](https://github.com/JiiahaoXU/XMark)
...
5. **DP-TwoLevel: Two-Stage Gradient Subspace Learning for Differentially Private Federated Learning**  
...
6. **Entropy-weighted Multi-layer Attention for Token-level Attribution in Autoregressive Language Models**  
   *SPIE Conference on Assurance and Security for AI-enabled Systems 2026* <br>
...
7. **Engineering Privacy at the Edge: A Practical Guide to Differential Privacy in System Architectures**  
...
8. **Privacy-Preserving Federated Learning for Science: Challenges and Research Directions**  
...
9. **Balancing Trade-offs: Adaptive Differential Privacy in Interpretable Machine Learning Models**  
...
10. **Optimal Client Sampling in Federated Learning with Client-level Heterogeneous Differential Privacy**  
    *IEEE Internet of Things Journal*  <br>
    [Link](https://ieeexplore.ieee.org/abstract/document/11373392) | [Code](https://github.com/JiiahaoXU/GDPFed)

11. **MIC-DP: A Scalable Correlation-Aware Differential Privacy Framework for High-Dimensional Data**  
...
12. **Privacy Preservation from High-Performance Computing to Autonomous Science [Industrial and Governmental Activities]**  
    *IEEE Computational Intelligence Magazine*  <br>
    [Link](https://ieeexplore.ieee.org/abstract/document/11079249)

13. **OmniFed: A Modular Framework for Configurable Federated Learning from Edge to HPC**  
